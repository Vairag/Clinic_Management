 ...
 * @author mayur
 */
public class Search_Patient_Between_to_Date extends javax.swing.JFrame {
    ...
    int count=0,total=0,flag_type1;
    String Item_List_String[],header[];
    Object alldata[][];
    public Search_Patient_Between_to_Date(int flag_type) {
        initComponents();
    ...
    private void FindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FindActionPerformed
        ...
        try{
           ...
           if(flag_type1==1)
           {
               pre = c.prepareStatement("Select Case_No from Diagosis_Details_All_Patient where Date_Of_Entry=?");
               pre.setDate(1, StartDate);
               
           }
           else
           {
               pre = c.prepareStatement("Select Case_No from Diagosis_Details_All_Patient where Date_Of_Entry>=? and Date_Of_Entry<=?");
               pre.setDate(1, StartDate);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Patient_Between_to_Date(2).setVisible(true);
            }
        });
    }
