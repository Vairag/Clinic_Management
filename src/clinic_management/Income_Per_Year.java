 ...
 * @author mayur
 */
public class Income_Per_Year extends javax.swing.JFrame {
    ...
    int count=0,total_income=0,total_expence=0,final_expence=0,final_income=0;
    String Item_List_String[],header[];
    Object alldata[][];
    public Income_Per_Year() {
        initComponents();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1173, Short.MAX_VALUE))
                .addContainerGap())
        ...
        try{
            ...
            int sy=Integer.parseInt((String)Year_Start.getSelectedItem());             
               ...
               for(int i=0;i<12;i++)
               {
                   ...
                   pre.setDate(1, new java.sql.Date(sy-1900,i,1));
                   pre.setDate(2, new java.sql.Date(sy-1900,i,31));
                   ...
                   total_patient+=count;
                   pre1 = c.prepareStatement("Select * from Extra_Expence where Date_Payment>=? and Date_Payment<=? order by Date_Payment");
                   pre1.setDate(1, new java.sql.Date(sy-1900,i,1));
                   pre1.setDate(2, new java.sql.Date(sy-1900,i,31));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Income_Per_Year().setVisible(true);
            }
        });
    }
